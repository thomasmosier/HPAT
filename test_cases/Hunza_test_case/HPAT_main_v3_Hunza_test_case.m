...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%% USER INPUTS (CAN EDIT TO CHANGE DEFAULT SETTINGS):    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Select the type of model run:
runType = 'default';	%Either 'default' (guess a parameter set), 
...
moduleSet = { ...
    'heat',  'Pelli'; ... %surface heat flux module representation
    ...
    'glaciervel', 'none'; ... %glacier movement representation
	'glaciermove', 'none'; ... %glacier movement representation
    'avalanche', 'none' %snow avalanching (can be 'none')
    };
            
                        
modelTimeStep = 'daily';     %String specifying time resolution.  Can be 
...
%GLACIER OPTIONS
%Select type of DEM grid for ice. 
iceGrid = 'same'; %Choices are:
                    ...
                    %'fine' = finer grid than main DEM (requires two grids:
                            ...
                            %high-res DEM)
%If using glaciers, select whether debris should be included                            
useDebris = 1;  %Set to 1 to load debris cover array. If 0, all ice presumed 
                %to be clean ice.      
                
%If using glaciers, select whether glacier ponds should be included                            
useIcePond = 1; %Set to 1 to load glacier lake cover array. If 0, presumed there are no glacier lakes
...
writeEval = 1;      %1 = Gridded files of observations and model output will be written during model evaluation.
                    %0 = No gridded files will be written for modelled output.
writeType = 'netcdf';    %'ascii' = individual ascii files (ESRI format)
...
%This path string is used to auto-load all inputs based on previous model run.    
path2Inputs = '';    
...
nRuns = 8000;   %Maximum number of runs (during calibration)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%ASSIGN INPUTS TO STRUCTURE ARRAYS (DO NOT EDIT):    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sMeta = struct;
